        ...
        <!-- Slides -->
          ...
          <div class="swiper-slide  overflow-hidden">
               ...
               <div class="row container-card-noticias">
                <div class="col-12"><img style="border-radius: 10% !important;" loading="lazy" src="https://gruporobles.com.pe/nuevaweb_assets/assets/img/test1.webp" alt=""></div>
                <div class="p-4">
            ...
            <div class="swiper-slide  overflow-hidden">
               ...
               <div class="row container-card-noticias">
                <div class="col-12"><img style="border-radius: 10% !important;" loading="lazy" src="https://gruporobles.com.pe/nuevaweb_assets/assets/img/test2.webp" alt=""></div>
                <div class="p-4">
               ...
               <div class="row container-card-noticias">
                <div class="col-12"><img style="border-radius: 10% !important;"loading="lazy" src="https://gruporobles.com.pe/nuevaweb_assets/assets/img/nosotros2-web.jpg" alt=""></div>
                <div class="p-4">
...
<script type="module" src="{{asset('nuevaweb_assets/js/mainWeb.js?v=211')}}"></script>
<script type="module">
