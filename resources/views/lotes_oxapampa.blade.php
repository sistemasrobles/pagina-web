...
<head>
  ...
  <meta name="description" content="Lotes en Oxapampa de Robles & Yasikov. Regístrate y descubre las mejores ofertas y promociones en lotes y cabañas." />
        ...
        <meta name="keywords" content="lotes,cabañas,inmobiliaria,proyectos,terrenos,casas,oxapampa">
...
<!-- End Meta Pixel Code -->
       ...
       <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-11027714488"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-11027714488');
</script>


<!-- Event snippet for Registro conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-11027714488/Nfr4COqy2ZAYELijtoop'});
</script>
  ...
  <div class="container-xl d-flex   justify-content-between align-items-center index-header ">
    ...
    <nav class="d-xxl-flex d-xl-flex d-md-flex  d-none  justify-content-center align-items-center gap-5">
      <ul class="list-header  list-group list-group-horizontal-xl  list-group-horizontal-md list-group-horizontal-xxl ">
        <li><a  href="{{url('/lotes-en-oxapampa')}}" class="text-dark">Inicio</a></li>
...
Aquí encontraremos 4 de nuestros condominios, siendo cada uno diferente, con la finalidad que consigas esa casa de campo que tanto anhelas.</p> 
          ...
          <div class="col-12 col-lg-5  text-dark  p-4 "  style="background: rgba(255, 255, 255, 0.93);">
               ...
               <h3 class="family-700-one color-green-2 contacto-span" style="padding:0px 20px">¡Regístrate y recibe hasta el 40% de dscto. en nuestros lotes!</h3> 
                        ...
                        <form  class="" id="promocion-form" method="POST" action="{{ route('/promociones/registrar') }}"  >
                           ...
                           <div class="form-row">
                            ...
                            <div class="row " >
                                ...
                                <option value="">Elige el horario de llamada</option>
  ...
  <section class="container-fluid ">
    ...
    <div class="col-12 col-lg-12  pt-3 pb-2 d-block d-lg-none " style="border-bottom: 1px dotted var(--color-primary-oscuro);">
           ...
           <h1 class="family-700-one color-green-2 " >Lotes en Oxapampa</h1> 

            <p style="font-size: 20px;" class="">En Robles & Yasikov, contamos con lotes disponibles en la maravillosa ciudad de Oxapampa.
Aquí encontraremos 4 de nuestros condominios, siendo cada uno diferente, con la finalidad que consigas esa casa de campo que tanto anhelas.</p> 
        ...
        <div class="col-lg-6">
          ...
          <div class=" swiper mySwiperBanner ">
              <div class="swiper-wrapper">
                <div class="swiper-slide"> <img src="{{asset('assets/img/brey.webp')}}" alt="" class="img-fluid" ></div>
                <div class="swiper-slide"> <img src="{{asset('assets/img/br2.webp')}}" alt="" class="img-fluid" ></div>
                <div class="swiper-slide"> <img src="{{asset('assets/img/br3.webp')}}" alt="" class="img-fluid" ></div>
...
Adquiere uno de nuestros lotes y disfruta de aire fresco, hermosas vistas desde nuestra colina y tranquilidad sin igual.
          ...
          <a href="https://gruporobles.com.pe/proyectos/lotes/el-bosque-del-rey?utm_source=landingpage&utm_medium=cpc&utm_campaign=lotes-en-oxapampa" target="_blank" type="button" class="btn bg-terce border-white py-2  px-5 raleway-medium text-white mt-3" style="">Conocer</a>
        </div>
    </div>
    ...
    <div class="row ">
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center align-items-center">
          ...
          <a href="https://gruporobles.com.pe/proyectos/lotes/bella-primavera?utm_source=landingpage&utm_medium=cpc&utm_campaign=lotes-en-oxapampa" target="_blank" type="button" class="btn bg-terce border-white py-2  px-5 raleway-medium text-white mt-3" style="">Conocer</a>
        </div>
    </div>
    ...
    <div class="row ">
        ...
        <div class="col-lg-6">
          ...
          <div class=" swiper mySwiperBanner ">
              <div class="swiper-wrapper">
                <div class="swiper-slide"> <img src="{{asset('assets/img/adorado.webp')}}" alt="" class="img-fluid"></div>
                <div class="swiper-slide"> <img src="{{asset('assets/img/adorado2.webp')}}" alt="" class="img-fluid"></div>
                <div class="swiper-slide"> <img src="{{asset('assets/img/adorado3.webp')}}" alt="" class="img-fluid"></div>
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center align-items-center">
          ...
          <a href="https://gruporobles.com.pe/proyectos/lotes/el-arco-dorado?utm_source=landingpage&utm_medium=cpc&utm_campaign=lotes-en-oxapampa" target="_blank" type="button" class="btn bg-terce border-white py-2  px-5 raleway-medium text-white mt-3" style="">Conocer</a>
        </div>
    </div>
    ...
    <div class="row ">
        ...
        <div class="col-lg-6 d-flex flex-column justify-content-center align-items-center">
          ...
          <a href="https://gruporobles.com.pe/proyectos/lotes/fundo-valentina?utm_source=landingpage&utm_medium=cpc&utm_campaign=lotes-en-oxapampa" target="_blank" type="button" class="btn bg-terce border-white py-2  px-5 raleway-medium text-white mt-3" style="">Conocer</a>
        </div>
    </div>
      ...
      <div style="width: max-content;" class="descubreMas px-5">
        ...
        <div class="d-flex gap-3">
          <ul class="d-flex flex-column gap-2">
            <li class="py-1"><a href="{{url('/lotes-en-oxapampa')}}">Inicio</a></li>
  ...
  <script type="module" src="{{asset('nuevaweb_assets/js/main.js?v=1')}}"></script>
          ...
          $("#errores").text('');
            ...
            if(response.status=='ok'){
                ...
                $("#promocion-form")[0].reset()
                  ...
                  setTimeout(function() {
                    window.location.href = "/lotes-en-oxapampa/gracias";
                  }, 3000); 
