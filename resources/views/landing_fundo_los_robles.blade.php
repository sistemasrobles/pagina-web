...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('assets_l_frobles/index.css?v=3444444434')}}" />
...
<link href="https://fonts.googleapis.com/css2?family=Allura&display=swap" rel="stylesheet">
    ...
    <meta name="description" content="Fundo Los Robles es un exclusivo desarrollo de lotes ubicado en el corazón de Oxapampa, rodeado de naturaleza y con un encanto único. Este proyecto ofrece la oportunidad de adquirir un espacio en un entorno privilegiado, donde la tranquilidad y la belleza del paisaje se combinan para brindar una experiencia de vida incomparable.">




        <meta name="author" content="Fundo Los Robles | Robles & Yasikov" />

        <meta name="keywords" content="terrenos,cabañas,inmobiliaria,proyectos,terrenos,casas,oxapampa">


        <meta property="og:url" content="https://gruporobles.com.pe/landing-fundo-los-robles" />

        <meta property="og:title" content="Fundo Los Robles | Robles & Yasikov" />

        <meta property="og:description" content="Fundo Los Robles es un exclusivo desarrollo de lotes ubicado en el corazón de Oxapampa, rodeado de naturaleza y con un encanto único. Este proyecto ofrece la oportunidad de adquirir un espacio en un entorno privilegiado, donde la tranquilidad y la belleza del paisaje se combinan para brindar una experiencia de vida incomparable." />
        ...
        >
          <div class="">
            ...
            >
              ...
              <p class="mb-0 text-center text-lg-start  out-regular icon-text" style="line-height: 25px;">
              <strong>Portico ingreso</strong>
              </p>
            </div>
          </div>
          <div class="">
            ...
            >
              ...
              <p class="mb-0 text-center text-lg-start color-plomo out-regular icon-text" style="line-height: 25px;">
          ...
          <div class="">
            ...
            >
              ...
              <p class="mb-0 text-center text-lg-start color-plomo out-regular icon-text" style="line-height: 25px;font-size: 0.8rem;" >
        ...
        'success': function(response){
          ...
          $("#errores").text('');
            ...
            if(response.status=='ok'){
              ...
              window.location.href = "/landing-fundo-los-robles/gracias";
