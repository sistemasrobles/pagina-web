      ...
      <div class="col-lg-12  d-none d-md-block" >
        ...
        <img src="https://gruporobles.com.pe/nuevaweb_assets/assets/img/logo-color.svg" height="100" width="200" class=" py-3" />
			...
			<div class="col-lg-8 " style="padding: 0px !important;margin:0px !important">
				<img src="https://gruporobles.com.pe/storage/banners/3031.webp" class="img-fluid w-100 h-100 d-block d-md-none"  />


        <img style="border-radius: 0px 0px 50px 0px;height: 90vh;object-fit: cover;"src="https://gruporobles.com.pe/storage/banners/30312.webp" class="img-fluid w-100  d-none d-md-block "  />
			</div>
            ...
            if(response.status=='ok'){
                ...
                $("#promocion-form")[0].reset()
                  ...
                  timer: 1500
                     ...
                     setTimeout(function() {
                    window.location.href = "/visitas-guiadas-2/gracias";
                  }, 3000); 
