...
<meta name="facebook-domain-verification" content="bwgiysma0oyiv4brb0k8tvs82pq6ik" />
  ...
  <link rel="stylesheet" href="{{asset('nuevaweb_assets/assets/css/main.css?v=1144')}}">
  <link rel="stylesheet" href="{{asset('nuevaweb_assets/assets/css/font.css')}}">

 <link rel="stylesheet" href="{{ asset('sweetalert2/sweetalert2.min.css') }}">
  <!-- Theme CSS -->
 
<script src="https://kit.fontawesome.com/aa5ca8edb3.js" crossorigin="anonymous"></script>
