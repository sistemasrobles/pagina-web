...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Lotes en Oxapampa de Robles & Yasikov. Regístrate y descubre las mejores ofertas y promociones en lotes y cabañas." />
        ...
        <meta property="og:url" content="https://gruporobles.com.pe/landing/lotes-en-oxapampa" />
        ...
        <title>Robles & Yasikov | {{$proyetoactual->descripcion}}</title>
...
.text-white{
  ...
  color :#000 !important;
   ...
   <link rel="stylesheet" href="{{ asset('country-select/build/css/intlTelInput.css') }}"/>
...
<script>
  ...
  <body>
    <main class="container-fluid p-0 m-0">
      ...
      <div
        class=" py-5 container-xl d-flex gap-2 justify-content-center align-items-center flex-column"
      >
          ...
          <span class="d-flex gap-2 flex-column mb-2">
           ...
           <!--  <input
            ...
            /> -->
             ...
             <input name="movil" type="text" id="movil" class="form-control"   oninput="return valideKey(event);"/> 
              ...
              <div class="input-data textarea">
                    ...
                    <div class="text-danger">
                                ...
                                <input class="" type="hidden" value="1" id="terminos" name="terminos" >
                                       ...
                                       <button  type="submit" id="btn-enviar-promo"  class="w-100 btn raleway-bold py-2 bg-terce  " style="background:#005c53;border-radius: 10px;color:#fff">Solicitar Información</button>
...
<script src="{{ asset('country-select/build/js/intlTelInput.js') }}"></script> 
          ...
          $("#errores").text('');
            ...
            if(response.status=='ok'){
                ...
                // })
                  ...
                  setTimeout(function() {
                    window.location.href = "/landing/lotes/"+slug+"/gracias";
                  }, 500); 
