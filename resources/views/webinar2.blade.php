  ...
  <body>
    ...
    <main class="container-fluid bg-main-img w-100 d-flex flex-column justify-content-center align-items-center"  >
        ...
        <img 
            ...
            src="https://gruporobles.com.pe/storage/banners/webinar-14marzo-d.webp"
          ...
          />
           ...
           <img 
            ...
            src="https://gruporobles.com.pe/storage/banners/webinar-14marzo-m.png"
            alt="WEBINAR GRUPO ROBLES & YASIKOV"
            srcset=""
          />
...
Si quieres salir de la rutina y explorar nuevos horizontes, ¡este evento es perfecto para ti!
    ...
    <section class="bg bg-white  py-4">
      ...
      <h2 class="color-primary out-Extrabold pt-5 mb-4 text-center" style="line-height:40px"><u>Conoce un poco mas de nuestros proyectos inmobiliarios</u></h2>

      <p class="out-normal mt-3 text-center">En Robles & Yasikov contamos con proyectos inmobiliarios a lo largo de la costa, sierra y selva del Perú. Conoce más sobre ellos a continuación.</p>
                ...
                //$("#form-proyect")[0].reset()
                  ...
                  timer: 1500
                     ...
                     setTimeout(function() {
                      ...
                      window.location.href = "/webinar-2/gracias";
