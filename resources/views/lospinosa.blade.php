      ...
      <div class="col-lg-12  d-none d-md-block" >
        ...
        <img src="https://gruporobles.com.pe/nuevaweb_assets/assets/img/logo-color.svg" height="100" width="200" class=" py-3" />
			...
			<div class="col-lg-8 " style="padding: 0px !important;margin:0px !important">
				<img src="https://gruporobles.com.pe/storage/banners/los-pinos-m.webp" class="img-fluid w-100 h-100 d-block d-md-none"  />


        <img style="border-radius: 0px 0px 50px 0px;height: 90vh;object-fit: cover;"src="https://gruporobles.com.pe/storage/banners/landing-los-pinos-d-2.webp" class="img-fluid w-100  d-none d-md-block "  />
			</div>
			...
			<div class="col-lg-4 px-5 py-5 py-md-0">
				...
				<div class="">
					 ...
					 <h1 class="color-primary">¡ Compra tu lote en una de las zonas mas exclusivas de Oxapampa !</h1>
...
<body>
   ...
   <section class="container-xl container-lg container-md container-sm ">
        ...
        <div class="pt-4 pb-2">
          <div class="d-flex flex-column gap-3 bg-white p-3 radius-section text-center">
            <h1 class="color-primary out-Extrabold mb-0 mt-3" style="line-height:40px">
              <u>BENEFICIOS EXCLUSIVOS DEL PROYECTO</u>
            </h1>
            <p class="out-normal mt-3">
              Accede a los beneficios exclusivos que te ofrece el proyecto La Retama en este entorno laboral
            </p>
     ...
     <section class="container-fluid ">
      ...
      >
        <div
          class="row row-cols-1 row-cols-lg-5 row-cols-md-3 g-2 justify-content-center"
        >
          <div class="" >
            <div
    ...
    <section class="container text-center">
          ...
          <div id="video-proyect" class=" video-proyect position-relative">
                ...
                <img id="image-video-proyect" class="img-fluid w-100" src='https://gruporobles.com.pe/storage/proyectos/fundo-los-pinos/bg_yt.png' alt="La Retama ">
            ...
            if(response.status=='ok'){
                ...
                $("#promocion-form")[0].reset()
                  ...
                  timer: 1500
                     ...
                     setTimeout(function() {
                    window.location.href = "/formulario/fundo-los-pinos/gracias";
                  }, 3000); 
