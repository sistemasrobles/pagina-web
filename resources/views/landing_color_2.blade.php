...
@keyframes spin {
    ...
    <title>Webinar Grupo Robles & Yasikov</title>
       <meta name="description" content="Te invitamos a nuestro webinar exclusivo donde expertos de la industria compartirán sus conocimientos y estrategias más recientes. No te pierdas esta oportunidad única de aprender, interactuar y hacer preguntas en tiempo real.">
        ...
        <meta property="og:url" content="https://gruporobles.com.pe/webinar-inversion" />
...
<script>
  ...
  <body>
    ...
    <!-- section ¿Por qué Invertir en Bellavista de Pacasmayo? -->
    <section class=" bg-granizo container-xl container-lg container-md container-sm py-5">
      <div class="d-flex flex-column justify-content-center align-items-center gap-4"  style="border-bottom: 1px solid black;">
        <div class="title-img">
          <img
            src="{{asset('assets_landing_color_2/img/elementos/letras.png')}}"
            alt=""
            srcset=""
          />
          <div class="text-center fs-4" style="color: #005552"><span style="font-size:1.1rem !important">CERCANOS A </span><strong style="font-weight:900">OXAPAMPA</strong></div>
        </div>
       
        <!-- card -->
        <div
          class="row row-cols-1 bg-proyectos row-cols-lg-3 row-cols-md-2 g-3 w-70 grid-card-proyect align-items-center justify-content-center"
        >
    ...
    <section class="py-4 section-bg ">
      <div
        class="container-xl container-lg container-md container-sm d-flex flex-column justify-content-center align-items-center"
      >
        <h2 class="text-center title-servicios mt-4 mb-4" style="font-weight:900">
          ...
          <div class="row  d-flex justify-content-center align-items-center gap-5">
              ...
              <div class="col-lg-3 mt-2"  style="height:520px">
                   ...
                   <div id="video-proyect2" class="text-center video-proyect position-relative ">
                        ...
                        <img id="image-video-proyect2" class="" src="{{asset('assets_landings/testimonio-morelia.webp')}}" alt="Testimonios del Grupo Robles & Yasikov" style="max-height:520px;border-radius:15px">
              ...
              <div class="col-lg-3 mt-2"  style="height:520px">
                   ...
                   <div id="video-proyect" class="text-center   video-proyect position-relative">
                        ...
                        <img id="image-video-proyect3" class="" src="{{asset('assets_landings/testimonio-final.webp')}}" alt="Testimonios del Grupo Robles & Yasikov" style="max-height:520px;border-radius:15px">
                ...
                //$("#form-proyect")[0].reset()
                  ...
                  timer: 1500
                     ...
                     setTimeout(function() {
                      ...
                      window.location.href = "/webinar-inversion/gracias";
